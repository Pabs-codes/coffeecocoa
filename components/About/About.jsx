        ...
        <Fade left cascade>
          <div className="justify-center hidden w-full py-10 my-20 space-x-5 md:px-10 lg:flex aspect-auto">
            <div className="space-y-5">
              <div className="h-64 -translate-x-24 xl:translate-x-0 w-64 rounded-xl shadow-xl bg-[url('/images/cocoahands.png')] bg-cover aspect-auto"></div>
              <div className="h-64 -translate-x-24 xl:translate-x-0 w-64 rounded-xl shadow-xl bg-[url('/images/WomanCocoaFarmer.jpeg')] bg-cover aspect-auto"></div>
            </div>
            <div className="hidden xl:block h-full w-72 rounded-xl shadow-xl bg-[url('/images/cocoapick.png')] bg-cover aspect-auto"></div>
          </div>
        </Fade>
        <Fade right cascade>
