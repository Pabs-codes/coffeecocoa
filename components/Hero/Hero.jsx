  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 flex items-center w-full h-screen px-5 py-32 mx-auto">
        <div className="relative z-10 flex flex-col items-left w-full ml-40">
          {/* Dummy content */}
          <Fade left>
          <p className="w-full pt-3 text-sm text-left text-white md:text-lg tracking-wide">
          ...
          <Fade right>
            ...
            <h1 className="text-left items-center pb-10  text-3xl font-bold pt-4 text-white md:text-5xl lg:w-2/3 md:leading-[3.5rem] tracking-wide">
